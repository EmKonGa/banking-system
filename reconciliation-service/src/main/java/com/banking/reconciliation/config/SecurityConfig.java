...
@Configuration
@EnableWebSecurity
// Required for @PreAuthorize on ReconciliationController — without it the annotation is inert and
// every authenticated user could read the whole system's discrepancies.
